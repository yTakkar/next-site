export default () => (
  <svg height="20" viewBox="0 0 230 45">
    <defs>
      <linearGradient x1="196.572434%" y1="228.815483%" x2="50%" y2="50%" id="linearGradient-2">
        <stop stopColor="#fff" offset="0%" />
        <stop stopColor="#000" offset="100%" />
      </linearGradient>
    </defs>
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Black-Full-Logo" transform="translate(-235.000000, -178.000000)" fillRule="nonzero">
