...
export default withPure(({children, disabled, invert, light, large, href, as, color, shadowColor, noHover, flat, full, className, ...props }) => {
  let a = (
    <a className={classNames(className, 'fw4 no-drag', {invert, disabled})} role='button' {...props}>
      {children}
      <style jsx>{`
        a {
