...
export const meta = {
  ...
  link: '/blog/next-5',
  twitterCard: `https://zeit-inc-res.cloudinary.com/image/upload/front/blog/next5/twitter-card.png`
}
...
<Image
  src={`${'https://zeit-inc-res.cloudinary.com/image/upload/front'}/blog/next5/zones.png`}
  width={4354 / 4}
  height={1456 / 4}
...
<GenericLink href="https://github.com/zeit/docs/pull/113">
  <Image
    src={`${'https://zeit-inc-res.cloudinary.com/image/upload/front'}/blog/next5/github.png`}
    width={1632 / 2.5}
    height={610 / 2.5}
    caption={
      <Fragment>
...
<Image
  src={`${'https://zeit-inc-res.cloudinary.com/image/upload/front'}/blog/next5/build.png`}
  width={2956 / 2.68}
  height={896 / 2.68}
  caption={
    <Fragment>
...
<Image
  src={`${'https://zeit-inc-res.cloudinary.com/image/upload/front'}/blog/next5/errors.png`}
  width={4354 / 4}
  height={1056 / 4}
