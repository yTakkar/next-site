...
export const meta = {
  ...
  twitterCard:
    'https://zeit-inc-res.cloudinary.com/image/upload/front' +
...
<Image src={'https://zeit-inc-res.cloudinary.com/image/upload/front' + '/blog/next6-1/server-dist.png'} width={1574/3} height={754/3} />
<Caption>
...
- Checking the [good first issue](https://github.com/zeit/next.js/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22good+first+issue%22) and [help wanted](https://github.com/zeit/next.js/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3A%22help+wanted%22) labels on [GitHub](https://github.com/zeit/next.js)
  ...
  <Image src={'https://zeit-inc-res.cloudinary.com/image/upload/front' + '/blog/next6-1/good-first-issue.png'} width={1968/3} height={1468/3} />
  <Caption>
