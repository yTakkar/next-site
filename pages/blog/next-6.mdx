...
For an example, [check out this website](https://out-khozebgbnl.now.sh/) deployed statically to Now. The websites [source code](https://github.com/vercel/next.js/tree/canary/examples/basic-css) is available too.
