...
ZEIT has a few large Next.js applications. For example, [zeit.co](https://zeit.co/), [zeit.co/docs](https://zeit.co/docs), and [nextjs.org](https://nextjs.org/). We've been [dogfooding](https://en.wikipedia.org/wiki/Eating_your_own_dog_food) Next.js internally at ZEIT and improved Next.js based on our experiences.
