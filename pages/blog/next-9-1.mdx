...
The initial implementation is currently being tested on production Next.js applications like [zeit.co](https://zeit.co).
...
<amp-twitter width="375"
  height="320"
  layout="responsive"
  data-tweetid="1162841909875892224"
...
The Next.js community on [spectrum.chat/next-js](https://spectrum.chat/next-js) now has over **11,250** members. [Join us](https://spectrum.chat/next-js)!
