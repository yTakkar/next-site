...
Furthermore `next-css` had a few missing constraints in how you can import CSS. For example you could import a CSS file in every file of the project, however this imported CSS file would be global for the whole application.

In order to solve improve developer experience and solve these inconsistencies we started working on bringing CSS imports support to Next.js by default.
...
This CSS file will be loaded via a `<link>` tag automatically injected into the default HTML markup Next.js generated.
