...
- **[Fast Refresh](#fast-refresh)**: fast and reliable HMR, as proven [at Facebook scale](https://twitter.com/dan_abramov/status/1152689338553131008)
...
You must specify `baseUrl` if you specify `paths`. You can learn more about the `paths` option [in the TypeScript documentation](https://www.typescriptlang.org/tsconfig#paths).
