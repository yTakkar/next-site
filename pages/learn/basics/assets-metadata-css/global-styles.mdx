...
- To use CSS Modules, import a CSS file named [`*.module.css`](/docs/basic-features/built-in-css-support#adding-component-level-css) in any component.
- To use global CSS, import a CSS file in [`pages/_app.js`](/docs/advanced-features/custom-app).
