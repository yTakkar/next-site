...
export const meta = {
  ...
  question: {
    answers: [
      ...
      "It didn't apply the title and showed an error in the console.",
      'It applied the title to the link after a full page reload.',
      'It applied the title, but with many warnings in the console.'
    ],
    correctAnswer: "It didn't apply the title and showed an error in the console."
  }
};
