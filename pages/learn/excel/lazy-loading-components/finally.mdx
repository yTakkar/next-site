...
We've only used the basic functionality of dynamic components. You can learn more about them by referring to [documentation](https://nextjs.org/docs/advanced-features/dynamic-import).
