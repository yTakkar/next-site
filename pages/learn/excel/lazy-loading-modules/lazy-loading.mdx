...
Luckily, we can easily do that with Next.js's [dynamic import](https://nextjs.org/docs/advanced-features/dynamic-import) functionality.
...
and it uses `require` to load the firebase modules.
