...
[Next.js](https://nextjs.org/) has support for [TypeScript](https://www.typescriptlang.org/) out of the box, making it possible to have type checking and other amazing features like:
