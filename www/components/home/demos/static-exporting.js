...
const CLI = () => (
  <Code lang="none">
    ...
    {' ~/my-site '}
    <span className="hljs-keyword">yarn build</span>
    {`
yarn run v1.9.4
...
`}
    <span className="hljs-keyword">▲</span>
    {' ~/my-site '}
    <span className="hljs-keyword">yarn export</span>
    {`
...
...
export default {
  ...
  browser2: {
    browserTabs: [
      'file:///.../my-site/out/index.html',
      'file:///.../my-site/out/about/index.html'
    ],
    browserMapping: {
  ...
  note: (
    <>
      <p>
        Export your Next.js website to static HTML, with zero cost. The export
        app supports almost every feature of Next.js including dynamic urls,
        prefetching, preloading and dynamic imports.
      </p>
      <p>
        With the{' '}
        <Link href="/docs#static-html-export">
          <a>
            <code>exportPathMap</code>
          </a>
        </Link>{' '}
        configuration, you can specify the routes and queries for the static
        export, copy custom files like <code>robots.txt</code>
