...
- [Next.js Learning guide improvements](#nextjs-learning)
...
We would like to thank everyone who has contributed to this Next.js release. Whether it’s contributing to the core or expanding and improving our ever growing [examples director](https://github.com/zeit/next.js/tree/canary/examples)y, we appreciate all contributions.
...
The Next.js community on Spectrum has grown to over **6,000 members**.

The Spectrum community is a place where you can chat about Next.js, get advice on how to solve problems, and help out other community members with your knowledge of Next.js.

[Join the community on Spectrum!](https://spectrum.chat/next-js)

<Image
  caption={<>The Spectrum community</>}
  captionSpacing={0}
  src="/static/blog/next-8-0-4/spectrum.png"
  width={1100 / 2}
  height={888 / 2}
/>
