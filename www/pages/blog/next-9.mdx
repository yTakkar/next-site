...
- **[Built-in Zero-Config TypeScript Support](#built-in-typescript-support)**: Build your application with increased confidence, thanks to automatic TypeScript support and integrated type-checking.
...
You can [read more about this feature in the Next.js Documentation](https://github.com/zeit/next.js#dynamic-routing) or Next.js Learn section.

<!-- TODO: link the Learn section -->
...
- `req` refers to [http.IncomingMessage](https://nodejs.org/api/http.html#http_class_http_incomingmessage)
- `res` refers to [http.ServerResponse](https://nodejs.org/api/http.html#http_class_http_serverresponse)
...
Next.js 9 now renders optimized AMP by default.
Optimized AMP is up to [50% faster](https://blog.amp.dev/2018/10/08/how-to-make-amp-even-faster/) than traditional AMP.

This was made possible by [Sebastian Benz](https://twitter.com/sebabenz)'s work on the
[AMP Optimizer](https://github.com/ampproject/amp-toolbox/tree/master/packages/optimizer).

Prior to v9, Next.js would provide both an original and optimized version of an AMP page.
This was necessary as the AMP Optimizer produced invalid AMP, which would cause it to
be skipped by search engine AMP indexing.
...
This change allows Next.js to remove dead code from compiled code automatically.
...
But also when using external tools that stitch log output together like the [Now CLI](https://zeit.co/download)
or `docker-compose`.
...
The Next.js community on [spectrum.chat/next-js](https://spectrum.chat/next-js) has
doubled since the last major release with over **8,600 members**.
Join us!
