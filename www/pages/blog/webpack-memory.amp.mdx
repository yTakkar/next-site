...
<Image caption={<>The Chrome Developer Tools memory profiler showed <strong>548 MB</strong> being allocated at once</>} captionSpacing={30} src="/static/blog/webpack-memory/allocation-before.png" width={2030 / 2.5} height={600 / 2.5} />
...
```
<Caption>Previous code that ran the function concurrently for all assets</Caption>
...
```
<Caption>New code that runs the function concurrently for a maximum of 15 at a time</Caption>
...
<Image caption={<>The profiler now showed chunks of <strong>34 MB</strong> being allocated over time</>} captionSpacing={30} src="/static/blog/webpack-memory/after-limiting.png" width={2060 / 2.5} height={886 / 2.5} />
...
<Image caption={<>After all optimizations the profiler shows chunks of <strong>184 KB</strong> being allocated over time</>} captionSpacing={30} src="/static/blog/webpack-memory/allocation-after.png" width={1280 / 2} height={212 / 2} />
