...
<Image
  caption={
    <>
      The Chrome Developer Tools memory profiler showed <strong>548 MB</strong>{' '}
...
<Image
  caption={
    <>
      The profiler now showed chunks of <strong>34 MB</strong> being allocated
      over time
    </>
  }
  captionSpacing={30}
...
<Image
  caption={
    <>
      After all optimizations the profiler shows chunks of{' '}
      <strong>184 KB</strong> being allocated over time
    </>
  }
  captionSpacing={30}
