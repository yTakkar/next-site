...
Then replace `pages/index.js` with the following content:
...
Everything on the above page will be familiar to you except `Index.getInitialProps` as shown below:
